            ...
            {isLoading ? (
              ...
              <div className="divide-y divide-border/40">
                {notifications.map((notif) => (
                  <div 
                    key={notif.id} 
                    className="flex flex-col sm:flex-row sm:items-center justify-between p-4 gap-4 hover:bg-muted/20 transition-colors group"
                  >
                    <div className="flex items-start gap-4">
                      <div className="mt-1 h-8 w-8 flex-shrink-0 flex items-center justify-center rounded-full bg-background border border-border/40 shadow-sm">
                        {notif.icon}
                      </div>
                      <div className="space-y-1">
